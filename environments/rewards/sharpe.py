...
class SharpeReward(BaseReward):
        ...
        Args:
            config: Configuration dictionary containing reward parameters.
                parameters:
                    ...
                    window_size: Window size for calculating returns and volatility (max length of returns history)
                    min_history_size: Minimum history size for calculating the Sharpe ratio (ideally >= 2)
    ...
    def calculate(
        ...
        **kwargs
        ...
        sharpe_ratio = 0.0  # Default to 0.0
    ...
    def __str__(self) -> str:
        ...
        return f"SharpeBasedReward(annual_risk_free_rate={self.annual_risk_free_rate}, window_size={self.window_size}, min_history_size={self.min_history_size}, scale={self.scale})"
