...
class TestNetworkConfig(unittest.TestCase):
    ...
    def test_technical_dim_configuration(self):
        ...
        tech_config = get_network_config(technical_dim=10)
        ...
        no_tech_config = get_network_config(technical_dim=None)
    ...
    def test_head_type_configurations(self):
        ...
        parametric_config = get_network_config(head_type='parametric')
        self.assertEqual(parametric_config['heads']['discrete']['type'], 'parametric')
        
        # Test bayesian head
        bayesian_config = get_network_config(head_type='bayesian')
    ...
    def test_discrete_head_configuration(self):
        ...
        enabled_config = get_network_config(include_discrete=True)
        self.assertTrue(enabled_config['heads']['discrete']['enabled'])
        
        # Test with discrete head disabled
        disabled_config = get_network_config(include_discrete=False)
    ...
    def test_confidence_and_value_heads(self):
        ...
        confidence_config = get_network_config(include_confidence=True)
        ...
        value_config = get_network_config(include_value=True)
    ...
    def test_head_dimensions(self):
        ...
        # Test large network
        large_config = get_network_config(price_type='both', technical_dim=50)
        ...
        # Test medium network
        medium_config = get_network_config(price_type='price', technical_dim=20)
